...
Course Summary
1. Unit 0: Introducing ClearPath Jackal Robot

a
2. Unit 1: Navigation Indoor

a
3. Unit 2: Set Outdoors Navigation

a
4. Unit 3: Detect and localise a person

a
5. Patrol with Jackal Micro Project
...
Introduction to TIAGo Robot
2. Control

Learn how to control TIAGo
3. Navigation

Navigate with TIAGo
4. Motion Planning with MoveIt: Part 1

Motion Planning with MoveIt: Part 1
5. Motion Planning with MoveIt: Part 2

Motion Planning with MoveIt: Part 2
6. Motion Planning with MoveIt: Part 3

Motion Planning with MoveIt: Part 3
7. Perception with OpenCV

Perception with OpenCV
8. Perception with PCL
...
8. Autonomous Navigation with RTAB-Map
...
4. Introduction to robot kinematics
...
3. How to Program an L-layer Neural Network in Python
...
6. Object and People Recognition with Convolutional Networks
...
7. Obstacle avoidance deep learning training
...
Course Summary
1. Unit 0: Robotniks Car platfrom

Introduction Unit where we present RB-CAR
2. Unit 1: RB-Car Introduction

Learn the basics of RB-CAR systems
3. Unit 2 Autonomous Outdoor Navigation

Learn to create a map and move around
4. Unit 3 Part1 TEB planning

Use TEB planning better for cars
5. Unit 3 Part2 Autonomous Outdoor Navigation

Use GPS navigation mergeing sensors for better odometry
6. Unit 4 Visual information management

Learn basic perception systems for autonomous driving
7. Unit 5 Final Project
...
Course Summary
1. Unit 0: Robotniks Vogui PLUS platfrom

Intro and demo
2. Unit 1 Part1: Indoor navigation

Learn how to navigate both indoor and outdoors
3. Unit 1 Part2 : Outdoor navigation and waypoints

Outdoor navigation with GPS and waypoints use
4. Unit2: Grasping and perception
