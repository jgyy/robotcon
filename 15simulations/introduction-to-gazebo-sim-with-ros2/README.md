...
The diagram below shows how each unit's output becomes the next unit's starting point, from orientation through to a fully worlded, ROS 2-connected robot.

```mermaid
flowchart LR
    U1[Unit 1: Introduction<br/>Gazebo naming & GUI tour] --> U2[Unit 2: Build a Robot<br/>URDF links, joints, spawning]
    U2 --> U3[Unit 3: Connect to ROS 2<br/>ros_gz_bridge & sensor/actuator plugins]
    U3 --> U4[Unit 4: Build a World<br/>SDF physics, models, actors, plugins]
```
