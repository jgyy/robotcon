...
4. [Building a custom Robot with Blender and Gazebo](04-building-a-custom-robot-with-blender-and-gazebo.md) — Modeling links with correct joint origins and assembling a controllable arm and mobile base in SDF/URDF.
5. [Adding Animations to Gazebo Sim](05-adding-animations-to-gazebo-sim.md) — Skeletal animation in Blender, glTF export with baked keyframes, and SDF `<actor>` playback in Gazebo Sim.
6. [Final Project](06-final-project.md) — Combining a custom world, a working robot, and animation into one complete, reproducible simulation.
