...
The diagram below shows how each unit builds on the previous one, from manual control to full autonomous 3D navigation:

```mermaid
flowchart LR
    U1[Unit 1<br/>Intro & Setup] --> U2[Unit 2<br/>Basic Control]
    U2 --> U3[Unit 3<br/>2D Nav with RTABMap]
    U3 --> U4[Unit 4<br/>3D Nav with MoveIt]
```
