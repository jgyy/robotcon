...
The diagram below shows how each unit builds on the one before it, from hardware fundamentals through to the final odometry project.

```mermaid
flowchart LR
    U1[Unit 1: Anatomy of a Robot] --> U2[Unit 2: Sensors]
    U2 --> U3[Unit 3: Robot Frames]
    U3 --> U4[Unit 4: Kinematics]
    U4 --> U5[Unit 5: Odometry]
```
