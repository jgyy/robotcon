...
The diagram below shows how each unit builds on the one before it, ending in the integration project that chains them all together.

```mermaid
flowchart TD
    U0[Unit 0: Platform tour and teleop] --> U1A[Unit 1 Part 1: Indoor navigation]
    U1A --> U1B[Unit 1 Part 2: Outdoor navigation and waypoints]
    U1B --> U2[Unit 2: Grasping and perception]
    U2 --> UP[Unit Project: fetch mission]
    U0 -.foundation for.-> UP
```
