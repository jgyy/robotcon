...
4. [Kinematics of Holonomic Robots](04-kinematics-of-holonomic-robots.md) — The motion properties of holonomic robots and how they affect kinematic modeling and control.
5. [Kinematic Control](05-kinematic-control.md) — Methods for controlling a robot's motion based on its kinematic model, ensuring accurate movement towards a desired position.
