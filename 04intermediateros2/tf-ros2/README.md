...
The diagram below shows how the four units build on each other, from core concepts through tooling, authoring transforms, and full-robot automation:

```mermaid
flowchart LR
    U1[Unit 1: Introduction to TF] --> U2[Unit 2: TF Tools and Visualization]
    U2 --> U3[Unit 3: Broadcast and Listen to TF Data]
    U3 --> U4[Unit 4: Robot State Publisher]
```
