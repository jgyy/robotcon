...
```mermaid
flowchart LR
    U1[Unit 1: Introduction to the Course] --> U2[Unit 2: Introduction to Behavior Trees]
    U2 --> U3[Unit 3: Design Principles]
    U3 --> U4[Unit 4: Integration with ROS2]
    U4 --> U5[Unit 5: Stochastic BTs and Planning]
