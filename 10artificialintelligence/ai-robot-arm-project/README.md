...
The diagram below shows how each unit's output becomes the next unit's starting point, from raw hardware to an edge-deployed policy.

```mermaid
flowchart LR
    U1[Unit 1: Hardware Setup,<br/>BOM &amp; First Bring-Up] --> U2[Unit 2: Task Definition &amp;<br/>Dataset Generation]
    U2 --> U3[Unit 3: Train ACT &amp;<br/>SmolVLA on Your Datasets]
    U3 --> U4[Unit 4: Deploy Trained<br/>Policies on the SO-101]
    U4 --> U5[Unit 5: Run ACT Policy on the<br/>Hailo-10H Edge NPU]
```
