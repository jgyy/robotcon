...
The diagram below shows how each unit builds directly on the environment and skills established by the one before it.

```mermaid
flowchart LR
    U1[Unit 1: MJLab ecosystem<br/>orient in the MuJoCo/Warp/MJLab stack] --> U2[Unit 2: MJLab basics<br/>scaffold project, train built-in robot]
    U2 --> U3[Unit 3: Terrains<br/>custom scenes, objects, procedural terrain]
    U3 --> U4[Unit 4: Robots<br/>integrate a new robot, joystick control]
```
