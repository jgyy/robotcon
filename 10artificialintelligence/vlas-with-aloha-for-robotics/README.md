...
The diagram below shows how each unit builds directly on the one before it, ending in the ACT policy the course is building toward.

```mermaid
flowchart LR
    U1[Unit 1: Introduction<br/>what a VLA is, why ALOHA] --> U2[Unit 2: Imitation Learning<br/>behavioral cloning]
    U2 --> U3[Unit 3: Actor-Critic RL<br/>reward-driven policy learning]
    U3 --> U4[Unit 4: ACT<br/>chunked transformer policy for ALOHA]
```
