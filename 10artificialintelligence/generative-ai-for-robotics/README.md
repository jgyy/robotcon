...
The diagram below shows how each unit's output becomes the next unit's input, from raw tokenization through to a robot navigating on spoken commands.
```mermaid
flowchart LR
    U1[Unit 1: Introduction] --> U2[Unit 2: Tokenization and Data Foundations]
    U2 --> U3[Unit 3: Training and Fine-Tuning]
    U3 --> U4[Unit 4: Natural Language Robot Control]
    U4 --> U5[Unit 5: Vision-Language Models]
    U5 --> U6[Unit 6: Generative AI for Robot Navigation]
```
