...
```mermaid
flowchart TD
    U1[Unit 1: Quick Demo] --> U2[Unit 2: Step-by-Step Guide]
    U2 --> U3[Unit 3: XY Motion + Fine-tuning]
    U3 --> U4[Unit 4: Distractor + Multi-task Head]
    U4 --> U5[Unit 5: Domain Randomization]
    U5 --> U6[Unit 6: Microproject - Garbage Collector]
```
